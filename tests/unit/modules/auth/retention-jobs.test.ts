...
describe('Unactivated Account Retention Jobs Unit Tests (Two-Job Architecture)', () => {
  ...
  describe('SendUnactivatedAccountRemindersUseCase', () => {
    it('should find accounts in warning window and create UNACTIVATED_ACCOUNT_REMINDER_SENT audit log', async () => {
  ...
  describe('DeleteExpiredUnactivatedAccountsUseCase', () => {
    it('should delete unactivated accounts past 12-month cutoff and create UNACTIVATED_ACCOUNT_RETENTION_REMOVED audit log per BRU-187', async () => {
